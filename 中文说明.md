...
对于直接使用CMake编译代码的用户，我们在GitHub项目的 "[examples/configuration](https://github.com/vincentjzy/OpenCorr/tree/main/examples/ide_configuration)" 目录下提供了一个CMake脚本的示例 CMakeLists.txt。
